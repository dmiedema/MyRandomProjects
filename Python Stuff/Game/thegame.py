'''
    Daniel Miedema's project.
    Uses python 2.7 I believe, or 2.6.  

    It won't work under 3.X I know that.
'''
...
class Game(object):
    ...
    def StartMenu(self):
        ...
        if choice == "1":
            print "\n" * 20, '\t' * 2, "Alright then.  Let's get this started.", '\n' * 10
            print "\n" * 20, '\t' * 2, "Alright then.  Let's get this started.", '\n' * 10
            print "\n" * 20, '\t' * 2, "Alright then.  Let's get this started.", '\n' * 10
            print "\n" * 20, '\t' * 2, "Alright then.  Let's get this started.", '\n' * 10
            print "\n" * 20, '\t' * 2, "Alright then.  Let's get this started.", '\n' * 10
            ...
            if Stats[0] < 1:
                ...
                if intinpt == None:
                    ...
                    if inpt == "S" or inpt == "s":
                        ...
                        elif RoomCount < RoomEntered - 3:
                            print "\nYou can only skip 3 rooms."
                            print "Go back and enter some rooms! Then we can go downstairs.."
                        else:    
			    ...
			    Stats[2] = Stats[2] - 1
                    ...
                    elif inpt == "idontcareabouttheroomsiwannamove":
                        RoomCount = Rooms
